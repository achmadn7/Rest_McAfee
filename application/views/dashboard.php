...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Admin - McAfee</title>
    <!-- BOOTSTRAP CORE STYLE  -->
    <link href="<?php echo base_url()?>template/assets/css/bootstrap.css" rel="stylesheet" />
    <!-- FONT AWESOME ICONS  -->
    <link href="<?php echo base_url()?>template/assets/css/font-awesome.css" rel="stylesheet" />
    <!-- CUSTOM STYLE  -->
...
<body>
    <header>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                  <strong>Email: </strong>info@kharismaworld.com
                  &nbsp;&nbsp;
                  <strong>Support: </strong>+62 812 812 28282
                </div>
  ...
  <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    @ 2017 PT. Kharisma Inside Mandiri Sejahtera - McAfee | Edit By : <a href="#" target="_blank">Anonymous</a>
                </div>
