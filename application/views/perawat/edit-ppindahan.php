                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <!-- form start  -->
                          <?php
                          echo form_open('perawat/sensus/edit_pindahan');
                          ?>
                          <input type="hidden" name="sensus" value="<?php echo $row['id_sensus'];?>">
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label>Tanggal</label>
                                      <div>
                                          <input class="form-control" type="text" value="<?php echo $row['tgl1'];?>" name="tgl_pindahan">
                                  ...
                                  <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                      <label>Dari Ruang</label>
                                        <input class="form-control" type="text" value="<?php echo $row['dari_ruang'];?>" name="dari_ruang">
                                      </select>
                                    </div>
                                  </div>
                                  <div class="col-lg-12">
                                    <div class="box-footer">
                                        ...
                                        <?php
                                          echo anchor('perawat/sensus/pasien_pindahan','Kembali',array('class'=>'btn btn-success btn-sm'));
                                        ?>
                                    </div>
                                  </div>
                                </div>
