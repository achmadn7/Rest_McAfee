...
<body>
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label>Tanggal</label>
                                      <div>
                                          <input class="form-control" type="text" name="tgl_pindahan" value="<?php echo date("Y-m-d"); ?>"></input>
    ...
    <!-- <script>
      $(document).ready(function() {
          $('#darikel').on('change',function(){
            var id_kelas = $(this).val();
            if (id_kelas == '')
            {
              $('#dariruangan').prop('disabled', true);
            }
            else {
              $('#dariruangan').prop('disabled', false);
              $.ajax({
                url:"<?php echo base_url() ?>perawat/pasienpindahan/pilih_kelas",
                type: "POST",
                data: {'id_kelas' : id_kelas},
                dataType: 'json',
                success: function(data){
                  $('#dariruangan').html(data);
                },
                error: function(){
                  alert('error...');
                }
