                  ...
                  <div class="col-lg-12">
                      <div class="panel panel-default">
                          <div class="panel-heading">
                              <?php
                                echo anchor('perawat/sensus/post_pindahan','Tambah',array('class'=>'btn btn-success btn-sm'));
                              ?>
                          </div>
                          <!-- /.panel-heading -->
                                     ...
                                     <?php
                                      ...
                                      foreach ($record as $r) {
                                        echo "<tr class='odd gradeX'>
                                              ...
                                              <td>$r->tgl1</td>
                                              <td>$r->jam</td>
                                              <td width='10'>".anchor("perawat/sensus/edit_pindahan/".$r->no_rm,"<span class='fa fa-pencil-square-o' aria-hidden='true'></span>",array('title'=>'edit data'))."</td>
                                              <td width='10'>".anchor("perawat/sensus/delete_pindahan/".$r->no_rm,"<span class='glyphicon glyphicon-trash' aria-hidden='true'></span>",array('title'=>'delete data'))."</td>
                                        </tr>";
                                        $no++;
                                      }
                                     ?>
