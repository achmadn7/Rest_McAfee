                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <!-- form start  -->
                          <?php
                          echo form_open('perawat/sensus/edit_keluar');
                          ?>
                          ...
                          <form method="post" accept-charset="utf-8">
                              <div class="box-body">
                                <div class="col-lg-12">
                                  <div class="col-lg-6">
                                    <input class="form-control" value="Pasien Keluar" name="status" type="hidden" required>
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      ...
                                      <div>
                                          <input class="form-control" type="text" value="<?php echo $row['tgl1'];?>" name="tgl_keluar">
                                  ...
                                  <div class="col-lg-2">
                                    <div class="form-group">
                                      <label>Jam</label>
                                      <div>
                                        <input class="form-control" name="jam_keluar" value="<?php echo $row['jam'];?>" type="text"></input>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                <div class="col-lg-12">
                                  <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div>
                                          <input class="form-control" type="text" name="tgl_masuk" value="<?php echo $row['tgl2'];?>"></input>
                                          <span class="add-on"><i class="icon-th"></i></span>
                                        </div>
                                    </div>
                                  </div>
                                  <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div>
                                          ...
                                          <label class="radio-inline">
                                            <input type="radio" name="cara_keluar" value="Dirujuk ke > Re" required>Dirujuk ke > Re
                                          </label>
                                          <label class="radio-inline">
                                            <input type="radio" name="cara_keluar" value="APS" required>APS
                                          </label>
                                          <label class="radio-inline">
                                            <input type="radio" name="cara_keluar" value="Mati < 48 J" required>Mati < 48 Jam
                                          </label>
                                          <label class="radio-inline">
                                            <input type="radio" name="cara_keluar" value="Mati >= 48 J" required>Mati >= 48 Jam
                                          </label>
