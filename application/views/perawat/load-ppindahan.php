                  ...
                  <div class="col-lg-12">
                    <div class="col-lg-6" style="margin-left: -15px;">
                      <div class="form-group">
                        ...
                        <?php echo form_open("perawat/sensus/load_pindahan"); ?>
                        <input type="hidden" name="id" value="<?php echo $row['id_ruang'];?>">
                        <input class="form-control" name="status"  value="Pasien Pindahan"type="hidden" required>
                  ...
                  <div class="col-lg-12">
                      <div class="panel panel-default">
                          <div class="panel-heading">
                              ...
                              ?>
                              <!-- <?php
                                echo anchor('perawat/pasienpindahan/export_excel','Export Excel',array('class'=>'btn btn-success btn-sm'));
                              ?> -->
                          </div>
                          <!-- /.panel-heading -->
                                     ...
                                     <?php
                                      ...
                                      foreach ($record as $r) {
                                        echo "<tr class='odd gradeX'>
                                              ...
                                              <td>$r->tgl1</td>
                                              <td>$r->jam</td>
                                              <td width='10'>".anchor("perawat/pasienpindahan/edit_pindahan/".$r->no_rm,"<span class='fa fa-pencil-square-o' aria-hidden='true'></span>",array('title'=>'edit data'))."</td>
                                              <td width='10'>".anchor("perawat/pasienpindahan/delete_pindahan/".$r->no_rm,"<span class='glyphicon glyphicon-trash' aria-hidden='true'></span>",array('title'=>'delete data'))."</td>
