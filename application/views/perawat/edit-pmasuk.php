                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          <!-- form start  -->
                          <?php
                          echo form_open('perawat/sensus/edit_masuk');
                          ?>
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="col-lg-4">
                                    <div class="form-group">
                                      <label>Tanggal</label>
                                      <div>
                                          <input class="form-control" type="text" value="<?php echo $row['tgl1'];?>" name="tgl_masuk">
                                ...
                                <div class="col-lg-12">
                                  ...
                                  <div class="col-lg-12">
                                    <div class="box-footer">
                                        ...
                                        <?php
                                          echo anchor('perawat/sensus','Kembali',array('class'=>'btn btn-success btn-sm'));
                                        ?>
                                    </div>
                                  </div>
                                </div>
