                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="<?php echo base_url()?>perawat/pasien_dipindahkan"><i class="fa fa-spinner" aria-hidden="true"></i> Pasien Dipindahkan</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url()?>perawat/pasien_keluar"><i class="fa fa-spinner" aria-hidden="true"></i> Pasien Keluar</a>
                            </li>
                            <li>
                  ...
                  <div class="col-lg-12">
                    <div class="col-lg-6" style="margin-left: -15px;">
                      <div class="form-group">
                        ...
                        <?php echo form_open("perawat/sensus/load_dipindahkan"); ?>
                                     ...
                                     <?php
                                      ...
                                      foreach ($record as $r) {
                                        echo "<tr class='odd gradeX'>
                                              ...
                                              <td>$r->tgl1</td>
                                              <td>$r->jam</td>
                                              <td width='10'>".anchor("perawat/sensus/edit_dipindahkan/".$r->no_rm,"<span class='fa fa-pencil-square-o' aria-hidden='true'></span>",array('title'=>'edit data'))."</td>
                                              <td width='10'>".anchor("perawat/sensus/delete_dipindahkan/".$r->no_rm,"<span class='glyphicon glyphicon-trash' aria-hidden='true'></span>",array('title'=>'delete data'))."</td>
