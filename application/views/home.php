  ...
  <body>
    	...
    	<div class="row">
          <div class="col-xs-12 col-md-8" style="margin: 100px auto; color: #fff;">
            ...
            <div class="col-md-8" style="padding-left: 20px; padding-top: 60px;">
              <span>
                Sistem Informasi Indikator Pelayanan Rawat Inap ialah sistem yang diapakai untuk mengetahui
                tingkat efisiensi pelayanan rawat inap pada Rumah Sakit. Indikator-indikator tersebut bersumber dari sensus harian rawat inap.
              </span>
            </div>
    ...
    <footer id="footer">
      <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <p>Desain Prototipe @ - https://github.com/achmadn7</p>
                <br>
                <div class="col-xs-6 col-md-4"></div>
                <div class="col-xs-6 col-md-4">
                  <p style="padding-top: 5px; padding-bottom: 5px; background-color: #00000080;">
                    <strong><a href="http://rsudpandanarang.boyolalikab.go.id/" target="_blank">Rumah Sakit Umum Pandan Arang Boyolali</a></strong>
                    <br>" V. Beta -- 2017 "
                  </p>
                </div>
                <div class="col-xs-6 col-md-4"></div>
