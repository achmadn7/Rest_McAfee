        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <!-- <li>
                        <a href="<?php echo base_url()?>rm/triwulan"><i class="fa fa-file" aria-hidden="true"></i> Data Triwulan</a>
                    </li> -->
                    <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Selamat Datang </strong>- Anda login sebagai Rekam Medis !
                        </div>
                    </div>
                </div>
                <!-- /.row -->
