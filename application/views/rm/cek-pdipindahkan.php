                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header">
                            <small><i class="fa fa-history"></i> Informasi Sensus</small>
                        </h3>
                    </div>
                </div>
                <!-- /.row -->
                  ...
                  <div class="col-lg-12">
                    <div class="col-lg-3">
                      <div class="form-group">
                        ...
                        <?php echo form_open("rm/sensus/cek"); ?>
                  ...
                  <div class="col-lg-12">
                      <div class="panel panel-default">
                          <div class="panel-heading">
                              <?php
                                echo anchor('perawat/pasiendipindahkan/export_excel','Export Excel',array('class'=>'btn btn-success btn-sm'));
                              ?>
                          </div>
                          <!-- /.panel-heading -->
