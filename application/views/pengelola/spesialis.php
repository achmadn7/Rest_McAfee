        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-arrows-v"></i> Data <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="<?php echo base_url()?>pengelola/bangsal">Bangsal</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                          <?php
                            echo anchor('pengelola/spesialis/post','Tambah',array('class'=>'btn btn-success btn-sm'));
                          ?>
                        </div>
                        <!-- /.panel-heading -->
